...
public class BreadShop升级版 {
    ...
    public static void main(String[] args) {
        ...
        for(int i = 0; i< 消费者数量; i++){
            consumers[i] = new Thread(new BreadShop进阶版.Consumer(String.valueOf(i)));
        }
        //同时启动10个生产者线程
        Thread[] producers = new Thread[生产者数量];
        for(int i = 0; i< 生产者数量; i++){
            producers[i] = new Thread(new BreadShop进阶版.Producer(String.valueOf(i)));
        }
